...
https://docs.apps.rancher.io/[SUSE Application Collection] provides a SUSE Rancher compatible cert-manager chart, follow the instructions below for installation.
