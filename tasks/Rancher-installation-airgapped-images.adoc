...
By default, all images used to link:https://documentation.suse.com/cloudnative/rancher-manager/v2.13/en/cluster-deployment/cluster-deployment.html[provision {k8s} clusters] or launch any tools in {ranchermanager}, e.g., monitoring, pipelines or alerts, are pulled from {dhub}.
