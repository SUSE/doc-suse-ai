...
After {sainodeinstaller} completes successfully, the nodes are fully prepared for {productname} workloads deployment as described in xref:ai-library-installing[].