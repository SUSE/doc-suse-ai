...
The steps in this procedure assume that all containers are deployed into the same namespace, referred to as `SAIF_NAMESPACE`.
...
----
{prompt_user}kubectl create namespace <SAIF_NAMESPACE>
----
