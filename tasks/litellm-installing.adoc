...
{litellm} is an open-source LLM proxy and abstraction layer that lets you interact with many different large language model providers through a single, OpenAI-compatible API.
endif::[]
