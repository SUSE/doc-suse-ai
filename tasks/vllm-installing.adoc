...
.{vllm} upgrade issue
====
While upgrading from Chart version 0.1.9 to 0.1.10, you may encounter the following error due to immutable label selector changes:
[source]
----
...
To resolve this issue, delete the affected deployments and then retry the upgrade:
