[#ai-lifecycle-manager-installing]
...
= Installing {sailifecyclemanager}
endif::[]
// overridden abstract?
...
. Import the extension catalog from GitHub.
  Enter `ghcr.io/suse/suse-ai-lifecycle-manager:<VERSION>` in the btn:[Catalog Image Reference] input filed.
