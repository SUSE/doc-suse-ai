...
* Deploying {productname} workloads using xref:ai-rancher-extension[{sairancherextension}].
...
:override-title: {ranchera} Extension
include::../concepts/ai-rancher-extension.adoc[leveloffset=+2]
:override-title: Installation
:override-abstract: {empty}
include::../tasks/ai-rancher-extension-installing.adoc[leveloffset=+3]
:override-title: User roles
:override-abstract: {empty}
include::../references/ai-rancher-extension-user-roles.adoc[leveloffset=+3]
:override-title: ClusterRepo repository
:override-abstract: {empty}
include::../tasks/ai-rancher-extension-clusterrepo-creating.adoc[leveloffset=+3]
include::../glues/ai-rancher-extension-user.adoc[]
