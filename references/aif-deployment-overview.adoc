...
The {productname} deployment process differs according to the following scenarios:
...
* You have {rancherprime} and all supportive components installed on the {kube} cluster.
