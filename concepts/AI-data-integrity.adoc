...
[#ai-components-prone-to-attacks]
...
* Specifying external data sources to the AI model knowledge base is described in {dsc}/suse-ai/1.0/html/openwebui-using/index.html#openwebui-chat-input-field-usage[Open WebUI chat input field usage]. 
